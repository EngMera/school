            ...
            <div class="card-body">
                ...
                @endif
                    ...
                    <form action="{{ url('students/update') }}" method="post" autocomplete="off">
                        @method('PUT')
                        @csrf
                    <h6 style="font-weight: bold ;font-family: 'Readex Pro', sans-serif; color: #28a745"class="mt-4">{{trans('Students_trans.personal_information')}}</h6><br>
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <hr class="my-4">
                    <h6 style="font-weight: bold ;font-family: 'Readex Pro', sans-serif; color: #28a745"class="mt-4">{{trans('Students_trans.Student_information')}}</h6><br>
                    <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
