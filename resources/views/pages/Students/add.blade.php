...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="font-weight: bold ;font-family: 'Readex Pro', sans-serif;color: #28a745">  {{trans('main_trans.add_student')}} </h4>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{ url('students') }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                            <h6 style="font-weight: bold ;font-family: 'Readex Pro', sans-serif; color: #28a745"class="mt-4">
                            ...
                            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right my-4" type="submit">
