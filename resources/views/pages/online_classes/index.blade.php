    ...
    <div class="row">
        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <a href="{{url('online/create')}}" class="btn btn-success my-4" role="button" aria-pressed="true">اضافة حصة اونلاين جديدة</a>
                    <a class="btn btn-warning" href="{{url('online/indirectCreate')}}">اضافة حصة اوفلاين جديدة</a>
