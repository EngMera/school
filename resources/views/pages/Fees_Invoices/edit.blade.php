        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    @endif
                    <h6 style="font-weight: bold ;font-family: 'Readex Pro', sans-serif; color: #28a745"class="mt-4">تعديل فاتورة</h6><br>

                    <form action="{{url('feeInvoice')}}" method="post" autocomplete="off">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
