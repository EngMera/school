    ...
    <div class="row">
        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                <h6 style="font-weight: bold ;font-family: 'Readex Pro', sans-serif; color: #28a745"class="mt-4">قائمة سندات القبض
                </h6>
                        ...
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                            ...
                            @foreach($receipt_students as $receipt_student)
                                ...
                                <td>{{$receipt_student->description}}</td>
                                    <td>
                                        <a href="{{url('receipt/edit/'.$receipt_student->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
