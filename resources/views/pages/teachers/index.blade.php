                        ...
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                            ...
                            @foreach($Teachers as $Teacher)
                                ...
                                <td>{{$Teacher->specializations->Name}}</td>
                                    <td>
                                        <a href="{{ url('teachers/'.$Teacher->id.'/edit')}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                ...
                                <div class="modal fade" id="delete_Teacher{{$Teacher->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="{{ url('teachers/'.$Teacher->id)}}" method="GET">
                                            {{method_field('delete')}}
                                            {{csrf_field()}}
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p> {{ trans('grades.warning_Grade') }}</p>
