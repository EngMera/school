    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post"  action="{{ url('Teacher/dashboard/attendance_report') }}" autocomplete="off">
                    @csrf
                    <h6 style="font-weight: bold ;font-family: 'Readex Pro', sans-serif; color: #28a745">معلومات البحث</h6><br>
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($student->attendence_status == 0)
                                        <span class="btn-danger p-1 rounded">غياب</span>
                                    @else
                                        <span class="btn-success px-2 py-1 rounded">حضور</span>
                                    @endif
                                </td>
                            </tr>
