<div class="modal fade" id="delete_exam{{$question->id}}" tabindex="-1"
    ...
    <div class="modal-dialog" role="document">
        <form action="{{url('Teacher/dashboard/question/destroy/'.$question->id)}}" method="post">
            {{csrf_field()}}
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p> {{ trans('classroom.Warning_class') }} <span class="text-danger">{{$question->title}}</span></p>
                </div>
