    ...
    <div class="row">
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <h6 style="font-weight: bold ;font-family: 'Readex Pro', sans-serif; color: #28a745" class="mb-4">قائمة الاختبارات</h6>
                    <a href="{{url('Teacher/dashboard/quiz/create')}}" class="btn btn-success btn-sm" role="button"
                        ...
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                            ...
                            @foreach($quizzes as $quizze)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('Teacher/dashboard/quiz/edit/'.$quizze->id)}}"
                                ...
                                <div class="modal fade" id="delete_exam{{$quizze->id}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <form action="{{url('Teacher/dashboard/quiz/destroy/'.$quizze->id)}}" method="post">
                                            {{csrf_field()}}
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p> {{ trans('classroom.Warning_class') }} {{$quizze->name}}</p>
